...
function DCardGallery(){
    ...
    useEffect(() => {
        ...
        fetch(`https://www.tubereader.practicalsoftware.com/php/get-all-articles.php?index=-2`, {
            method: 'GET',
            headers: {
    ...
    useEffect(() => {
        ...
        var endpoint = `https://www.tubereader.practicalsoftware.com/php/get-all-articles.php?index=${index-1}`;
    ...
    */
    ...
    function searchTitle(title) {
        ...
        debounceTimer = setTimeout(function() {
            var endpoint = `https://www.tubereader.practicalsoftware.com/php/get-all-articles.php?index=-3`;
